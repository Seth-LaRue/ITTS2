  ...
  argonPage(
    fluidRow(
      column(12,
             ...
             tags$p("This data visualization tool was developed for the Southeast Trade and Transportation Study (SETTS) initiated by the Institute for Trade and Transportation Studies (ITTS)."),
             ...
             tags$p("Click on the Maps tab to explore the data."),
             ...
             tags$ul(tags$li(p("Based on Federal Highway Administration’s Freight Analysis Framework (FAF) version 5.2.")),
                     tags$li(p(paste0("Aggregated into the following 12 commodity groupings to streamline and simplify navigation and performance:  ",
                                      commasep(commodities),'.'))),
